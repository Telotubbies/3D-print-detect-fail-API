...
เราสร้างระบบตรวจจับความผิดพลาดของงานพิมพ์ 3D เช่น “สปาเก็ตตี้” หรือชิ้นงานล้มเหลว โดยใช้ YOLOv8 ในการวิเคราะห์รูปภาพ พร้อมกับ FastAPI เป็น backend สำหรับให้บริการ API ของระบบ

ฟีเจอร์หลักของระบบ:

ตรวจจับแบบเรียลไทม์ จากรูปภาพของงานพิมพ์

เว็บเดโม ให้ผู้ใช้สามารถอัปโหลดภาพและดูผลลัพธ์ทันที

เก็บประวัติการตรวจจับ ใน SQLite

ใช้ API Key เพื่อควบคุมการเข้าถึง

เซิร์ฟไฟล์ผลลัพธ์ชั่วคราว สำหรับดาวน์โหลดหรือดูบนเว็บ

ระบบนี้ช่วยให้ผู้ใช้สามารถตรวจสอบคุณภาพงานพิมพ์ 3D ได้ง่ายและรวดเร็ว โดยไม่ต้องตรวจด้วยสายตาเพียงอย่างเดียว และสามารถเก็บข้อมูลเพื่อวิเคราะห์ย้อนหลังได้
---
